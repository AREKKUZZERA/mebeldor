...
const services = [
  ...
  },
  {
    icon: "✦",
    title: "Дизайн-проект",
    text: "Наши специалисты разработают уникальный проект мебели с учётом всех ваших требований и пожеланий. 3D-визуализация до согласования — правки вносятся до тех пор, пока результат вас не устроит.",
    detail: "Бесплатно · 3D-визуализация",
  },
  {
    icon: "⬡",
    title: "Изготовление",
